...
void DockManager::createHousePalette() {
    ...
    m_housePalette = new HousePalettePanel(
        m_editorController ? m_editorController->getBrushStateService() : nullptr,
        m_editorController ? m_editorController->getClientDataService() : nullptr
    );
...
void DockManager::createWaypointPalette() {
    ...
    m_waypointPalette = new WaypointPalettePanel();
