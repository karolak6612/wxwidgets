...
private:
    ...
    QIcon getMaterialIcon(quint16 materialId) const;
    
    // Category matching
    bool itemMatchesCategory(const RME::core::assets::ItemData* item, const QString& category) const;
    bool materialMatchesCategory(const RME::core::assets::MaterialData* material, const QString& category) const;
};
