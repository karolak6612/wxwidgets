...
void TestEditorController::testDeleteSelection_NotEmpty() {
    ...
    auto* cmd = dynamic_cast<RME::core::actions::DeleteSelectionCommand*>(m_mockUndoStack->lastPushedCommandRaw);
    QVERIFY(cmd != nullptr);
...
void TestEditorController::testHandleDeleteSelection_WithSelection() {
    ...
    QVERIFY(m_mockUndoStack->pushCalled);
    QVERIFY(m_mockUndoStack->lastPushedCommandRaw != nullptr);
    auto* cmd = dynamic_cast<RME::core::actions::DeleteCommand*>(m_mockUndoStack->lastPushedCommandRaw);
    QVERIFY(cmd != nullptr);
...
void TestEditorController::testClearSelection_NotEmpty() {
    ...
    QVERIFY(m_mockUndoStack->pushCalled);
    QVERIFY(m_mockUndoStack->lastPushedCommandRaw != nullptr);
    auto* cmd = dynamic_cast<RME::core::actions::ClearSelectionCommand*>(m_mockUndoStack->lastPushedCommandRaw);
    QVERIFY(cmd != nullptr);
...
void TestEditorController::testPerformBoundingBoxSelection_NonAdditive_CurrentFloor() {
    ...
    QVERIFY(m_mockUndoStack->pushCalled);
    QVERIFY(m_mockUndoStack->lastPushedCommandRaw != nullptr);
    auto* cmd = dynamic_cast<RME::core::actions::BoundingBoxSelectCommand*>(m_mockUndoStack->lastPushedCommandRaw);
    QVERIFY(cmd != nullptr);
