...
""",
    "wxwidgets/border_editor_window.h": """// border_editor_window.h - Provides a visual editor for auto borders
...
analyzed_files_data = []
file_descriptions = {
    "wxwidgets/border_editor_window.cpp": "Implements `BorderEditorDialog`, a wxDialog with a notebook for editing \"Border\" definitions (visual grid for assigning items to border parts, saved to borders.xml) and \"Ground\" brush definitions (items with chances, border associations, saved to grounds.xml and tilesets.xml).",
    "wxwidgets/border_editor_window.h": "Header for `BorderEditorDialog` and related custom controls like `BorderGridPanel` and `BorderPreviewPanel`. Defines enums for border edge positions."
}
...
output_filename = "enhanced_wbs_yaml_files/UI-05.yaml"
