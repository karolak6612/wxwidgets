...
void EditorInstanceWidget::connectSignals()
{
    ...
    if (m_map) {
        // Connect to map modification signals
        if (m_editorController) {
            connect(m_editorController, &EditorController::mapModifiedChanged, 
                    this, &EditorInstanceWidget::onMapModifiedChanged);
        }
    ...
    if (m_editorController) {
        // Connect to editor controller signals
        if (m_editorController) {
            connect(m_editorController, &EditorController::mapChanged, 
                    this, &EditorInstanceWidget::onMapChanged);
            connect(m_editorController, &EditorController::selectionChanged, 
                    this, &EditorInstanceWidget::onSelectionChanged);
        }
    }
}
