...
yaml_data = {
    ...
    "dependencies": [
        "NET-01", # Defines the network protocol, message structures, and serialization/deserialization logic to be tested.
        "TEST-01" # Core data structures (like Position, Item, etc.) might be part of network messages.
    ],
...
output_file_path = "enhanced_wbs_yaml_files/TEST-06.yaml"
