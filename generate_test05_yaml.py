...
yaml_data = {
    ...
    "dependencies": [
        "CORE-05", # Defines base actions, copy buffer, undo stack
        "LOGIC-02", # Defines Bounding-Box Selection
        "LOGIC-03", # Defines Cut, Copy, Paste & Move logic
        "TEST-01",  # Core data structures (Map, Tile, ItemData) must be stable
        "CORE-04"   # Brush system (CORE-04) might be needed for fill action tests
    ],
...
output_file_path = "enhanced_wbs_yaml_files/TEST-05.yaml"
