...
yaml_data = {
    ...
    "dependencies": [
        ...
        "LOGIC-01", "LOGIC-02", "LOGIC-03", "LOGIC-04", "LOGIC-05", "LOGIC-07",
        "TEST-01"
    ],
...
output_file_path = "enhanced_wbs_yaml_files/TEST-09.yaml"
