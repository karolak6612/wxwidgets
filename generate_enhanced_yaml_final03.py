...
yaml_content = {
    ...
    "dependencies": [
        "UI-DIALOGS-02"  # As per WBS, this implies Preferences Dialog is mostly done.
    ],
...
4. Ensure `AppSettings` supports all configuration keys from the `Config::Key` enum (originally in `wxwidgets/settings.h`). You might need to copy/adapt this enum.
