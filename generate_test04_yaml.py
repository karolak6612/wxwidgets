...
yaml_data = {
    ...
    "dependencies": [
        "CORE-03", # Map saving/loading might be used to create initial states for some tests if simpler than programmatic creation.
        "CORE-04", # Defines the brush and material system being tested.
        "TEST-01", # Core data structures (Map, Tile, ItemData) must be stable.
    ],
...
This task is for creating new unit tests for the Qt6 brush and material system. The system itself, developed under CORE-04, handles the logic for how different brush types (ground, wall, item, doodad, creature, eraser) modify the map data. These tests will validate this application logic, including complex behaviors like auto-bordering for ground tiles and correct placement of multi-tile doodads.\
""",
    "definition_of_done": [
...
output_file_path = "enhanced_wbs_yaml_files/TEST-04.yaml"
