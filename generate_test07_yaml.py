...
yaml_data = {
    ...
    "dependencies": [
        "RENDER-01", # OpenGL Viewport implementation
        "RENDER-02", # Map Data Rendering logic
        "RENDER-03", # Sprite Rendering logic
        "CORE-03",   # For loading OTBM test map files
...
output_file_path = "enhanced_wbs_yaml_files/TEST-07.yaml"
